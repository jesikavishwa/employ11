...
interface EmploySalary//interface declaration
{
    
    public double netSalaryCal();
}
abstract class Employ11 implements EmploySalary{ //abstract class declaration
    String name;
    int id;
    //get-set methods
...
class SalaryCalculate extends Employ11//concrete class
{
    float salary;
    float basic_pay;
    float hra;
